...
const sandBoxUrl = 'https://www.vfd.mamamoniapp.com/';
const prodUrl = 'https://vfd.mamamoniapp.com/';
...
class CustomAPIUtils {
  ...
  static Future<Map<String, dynamic>> postRequest(
    ...
    try {
      ...
      http.Response apiResponse = await http.post(_apiPath(apiUrl),
          body: requestBody, headers: enableHeader ? await _headers() : {});
  ...
  static Future<String> getToken() async {
    String authKey = await storageData.read(keyRegisterAuth);
